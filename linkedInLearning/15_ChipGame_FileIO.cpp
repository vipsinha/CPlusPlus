...
int main()
{
    ...
    // output file name
    ofstream outFileChips;

    // open the file in append mode
    outFileChips.open("WriteFileChips", ios::app);
    ...
    do
    {
        ...
        //increment the counter for each move
        moveCounter++;
        ...
        else
        {
            ...
            outFileChips << playerName[numPlayer] << " won with " << moveCounter << "moves\n";
